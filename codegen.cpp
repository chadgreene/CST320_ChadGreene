...
void codegen::EmitInteger(int val)
{
...
//*****************************************
// Assign Temp value
void codegen::AssignTemp(int val)
{
...
//*****************************************
// Assign Temp_F value
void codegen::AssignTemp(float val)
{
    fprintf(Output, "Temp_F = %f;\n", val);
}

// //*****************************************
// // Push int value into memory
// void codegen::Push(int offset, int val)
// {
//     fprintf(Output, "INT_VAL(Frame_Pointer+%d) = %d;\n", offset, val);
// }

// //*****************************************
// // Push float value into memory
// void codegen::Push(int offset, double val)
// {
//     fprintf(Output, "FLOAT_VAL(Frame_Pointer+%d) = %f;\n", offset, val);
// }

//*****************************************
// Reference value from memory
...
//*****************************************
// Increase stack size
void codegen::IncreaseStack(int size)
{
...
//*****************************************
// Reduce stack size
void codegen::ReduceStack(int size)
{
    fprintf(Output, "Stack_Pointer -= %d;\n", size);
}
